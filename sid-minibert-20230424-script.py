...
def data_preprocessing(training_data):
    ...
    # create dataloaders
    train_dataloader = DataLoader(dataset=training_dataset, shuffle=True, batch_size=16) #  batch_size original value was 32
    val_dataloader = DataLoader(dataset=validation_dataset, shuffle=False, batch_size=32) # batch_size original value was 64
